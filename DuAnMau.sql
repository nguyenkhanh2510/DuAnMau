...
/****** Object:  Database [DuAnMau]    Script Date: 19/1/2022 6:43:18 PM ******/
CREATE DATABASE [DuAnMau]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DuAnMau', FILENAME = N'C:\Games\MSSQL15.SQLEXPRESS01\MSSQL\DATA\DuAnMau.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DuAnMau_log', FILENAME = N'C:\Games\MSSQL15.SQLEXPRESS01\MSSQL\DATA\DuAnMau_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
